...
const validateCred = (array)=>{
    ...
    for (let i = array.length-2; i>=0;i=i-2){
        if(array[i]*2>9){
            doubler = doubler + array[i]*2-9   
        } else {
            doubler = doubler + array[i]*2
        }  
      }
...
function findInvalidCards(cards) {
  ...
  console.log(idInvalidCardCompanies(findInvalidCards(batch))); // Find out which companies have mailed out invalid cards
